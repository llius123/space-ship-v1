...
export class Ship {
  ...
  constructor(public mainNode: PIXI.Application<HTMLCanvasElement>) {}
  ...
  public async setup() {
    ...
    this.mainNode.stage.addChild(this._container);
  }
  ...
  public repositionSprite({ x, y }: { x: number; y: number }) {
